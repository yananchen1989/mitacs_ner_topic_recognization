...
# model from https://www.sbert.net/docs/pretrained_models.html#sentence-embedding-models

# may need fine tune embedding models on quantum dataset
topic_model = BERTopic(verbose=True, embedding_model="all-mpnet-base-v2", min_topic_size=50)
topics, probs = topic_model.fit_transform(df['abstract'].tolist()); len(topic_model.get_topic_info())
